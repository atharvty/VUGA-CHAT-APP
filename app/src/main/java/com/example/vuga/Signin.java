...
import com.example.vuga.databinding.ActivitySigninBinding;
...
public class Signin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.mindchangesignup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Signin.this,signup_login.class);
                startActivity(intent);
